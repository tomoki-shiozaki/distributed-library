...
本アプリは Google Cloud の Cloud Run 上にデプロイされており、[こちらの URL](https://distributed-library-1066453624488.asia-northeast1.run.app/)から実際にお試しいただけます。デプロイ・実行環境の詳細は[こちら](#デプロイ・実行環境)をご覧ください。
